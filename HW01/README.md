...
>уровень изоляции транзакций, который гарантирует,
>что транзакция видит только подтверждённые изменения других транзакций
...
![create table](images/hw1_READ%20COMMITTED.png)
***
#### Уровень изоляции "REPEATABLE READ"
>уровень изоляции транзакций в управлении базами данных,
>который гарантирует, что повторное чтение данных возвращает те же значения,
>что были в начале транзакции
...
![create table](images/hw1_REPEATABLE_READ.png)
***
...
![create table](images/hw1_SERIALIZABLE.png)
